...
function ContactUs() {
  ...
  function submitButton(passed) {
    if (passed) {
      return <button type="submit" className="mt-2 text-white bg-blue-500 border-0 py-2 px-10 focus:outline-none hover:bg-blue-600 rounded text-lg">Send</button>
    }
      ...
      <section className="text-gray-600 body-font relative mt-10 mb-36">
        <div className="container md:items-center px-5 mx-auto flex lg:flex-row sm:flex-col flex-wrap">
          <div className="lg:w-1/2 md:w-4/5 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative lg:h-screen h-96">
            ...
            <div className="bg-white w-11/12 relative flex flex-wrap py-6 rounded shadow-md">
              ...
              <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                ...
                <a className="text-blue-500 leading-relaxed">contact@imgogportage.com</a>
          ...
          <div className="lg:w-5/12 md:w-full bg-white flex flex-col md:ml-auto w-full xs:px-12 sm:px-12 mt-20 mb-10 md:mt-10">
            ...
            <p className="mb-12 text-5xl text-center"> <a href="tel:12197624423" className="text-blue-500 cursor-pointer hover:text-blue-500 font-marker">(219)762-4423</a></p>
            ...
            <form action="https://getform.io/f/d7661c51-73c1-41e2-a669-580b50c55fb5" method="POST">
              <div className="relative mb-4">
                <input type="text" placeholder="Your name" id="name" name="name" className="w-full bg-white rounded border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-orange-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
              </div>
              <div className="relative mb-4">
                <input type="email" placeholder="Your e-mail address" id="email" name="email" className="w-full bg-white rounded border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-orange-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
              </div>
              <div className="relative mb-4">
                <input type="phone" placeholder="(219)555-5555" id="phone" name="phone" className="w-full bg-white rounded border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-orange-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
              </div>
              <div className="relative mb-4">
                <textarea id="message" placeholder="How can we help you?" name="message" className="w-full bg-white rounded border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-orange-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
              </div>
