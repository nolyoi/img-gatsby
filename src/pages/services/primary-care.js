  ...
  return (
    <div>
      ...
      <section className="bg-white bg-opacity-0 mt-0 w-full h-1/2">
        <div className="w-full h-1/2 bg-gray-900 bg-opacity-100 overflow-hidden text-center relative" style={{ backgroundImage: 'url(../primary-care.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
