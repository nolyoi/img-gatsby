...
function AboutUs() {
    ...
    return (
                        ...
                        <div className="grid gap-8 mt-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
                            <div className="w-full max-w-xs text-center">
                                ...
                                <div className="mt-2">
                                    ...
                                    <a onClick={() => setShowModal(true)} className="text-indigo-500 inline-flex items-center">Learn More
        ...
        <>
          ...
          >
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                <div className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t align-middle">
                  <h3 className="text-3xl font-semibold">
                    Doctor Shreyas Desai
                  </h3>
                  <button
                    className="p-1 ml-auto bg-red-500 rounded border-0 text-black float-right text-3xl leading-none font-semibold outline-none focus:outline-none"
                    onClick={() => setShowModal(false)}
                  >
                    <span className="text-white z-50 h-6 w-6 text-2xl block outline-none focus:outline-none">
                      ×
                    </span>
                  </button>
                </div>
                ...
                <div className="relative p-6 flex-auto">
                  ...
                  <p className="mt-4 mb-0 text-blueGray-500 text-lg leading-relaxed">
                    I always felt like I could do anything. That’s the main
                    thing people are controlled by! Thoughts- their perception
                    of themselves! They're slowed down by their perception of
                    themselves. If you're taught you can’t do anything, you
          ...
          <div className="filter blur-sm opacity-30 fixed inset-0 z-40 bg-black"></div>
        </>
      ) : null}
