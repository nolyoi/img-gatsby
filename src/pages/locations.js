          ...
          <section className="text-gray-600 body-font relative" id="portage">
            ...
            <div className="container px-5 py-24 mx-auto flex flex-wrap h-100">
              ...
              <div className="my-auto h-100 lg:w-1/3 md:w-1/2 w-full bg-white flex flex-col md:ml-auto w-full md:py-2 mt-0 md:mt-0">
                ...
                <p className="mb-20 text-5xl"> <a href="tel:12197624423" className="text-blue-500 cursor-pointer hover:text-blue-500 font-marker">(219)762-4423</a></p>
              </div>
            </div>
          </section>
          <section className="text-gray-600 body-font relative">
            <div className="container px-5 py-24 mx-auto flex flex-wrap h-100" id="gary">
              ...
              <div className="my-auto h-100 lg:w-1/3 md:w-1/2 w-full bg-white flex flex-col md:ml-auto w-full md:py-2 mt-0 md:mt-0">
                ...
                <p className="mb-20 text-5xl"> <a href="tel:882-2305" className="text-blue-500 cursor-pointer hover:text-blue-500 font-marker">(219)882-2305</a></p>
              </div>
            </div>
          </section>
          <section className="text-gray-600 body-font relative" id="suboxone">
            <div className="container px-5 py-24 mx-auto flex flex-wrap h-100">
              ...
              <div className="my-auto h-100 lg:w-1/3 md:w-1/2 w-full bg-white flex flex-col md:ml-auto w-full md:py-2 mt-0 md:mt-0">
                ...
                <p className="mb-20 text-5xl"> <a href="tel:12192924501" className="text-blue-500 cursor-pointer hover:text-blue-500 font-marker">(219)292-4501</a></p>
              </div>
            </div>
          </section>
        </div>
