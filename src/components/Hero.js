  ...
  return (
    <div className="flex bg-white bg-opacity-0 mt-0 w-full h-screen">
      <HeroCarousel interval={7000}>
        <div className="flex w-full h-screen bg-gray-800 shadow-xl bg-opacity-70 overflow-hidden text-center relative" style={{ backgroundImage: 'url(./addiction.jpeg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="flex w-full h-screen bg-gray-800 shadow-xl bg-opacity-70 overflow-hidden text-center relative" style={{ backgroundImage: 'url(./glove-heart.jpeg)', backgroundRepeat: 'no-repeat', backgroundSize: 'contain', backgroundPosition: 'left', backgroundColor: '#EBEEED' }}>
          <div className="m-auto">
            <div className="w-9/12 mx-auto text-gray-800 items-center content-center h-full">
              ...
              <h1 className="lg:mt-12 sm:mt-2 sm:mb-2 lg:mb-4 lg:pr-8 text-center font-sans text-3xl font-bold tracking-tight text-gray-700 sm:text-4xl sm:leading-none">Welcome to our new doctor, <span className="text-indigo-600 font-bold">T. Patel, MD</span>!</h1>
