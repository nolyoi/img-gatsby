  ...
  return (
    <div className="flex bg-white bg-opacity-0 mt-0 w-full h-screen shadow-lg">
      <HeroCarousel interval={8000}>
        ...
        Continuity of Care
         */}
        <div className="flex w-full h-screen bg-gray-50 overflow-hidden text-center relative" style={{ backgroundImage: 'url(./continuity.png)', backgroundRepeat: 'no-repeat', backgroundSize: 'contain', backgroundPosition: 'left' }}>
          <div className="m-auto grid grid-cols-12">
            <div className="col-span-5 col-start-6 mx-auto text-gray-800 items-end content-center h-full">
              ...
              <Link to="/services" className="inline-flex mt-8 items-center justify-center w-50 h-10 px-4 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-red-600 hover:bg-red-700 focus:shadow-outline focus:outline-none">Browse our services</Link>
            </div>
          </div>
        </div>
