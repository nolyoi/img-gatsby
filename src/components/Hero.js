...
<div className="container flex flex-col-reverse md:flex-col md:mx-auto mx-10 mb-24 md:mt-24 mx-auto space-y-6 lg:h-128 lg:py-24 lg:flex-row lg:items-center lg:space-x-6 mt-10">
            <div data-sal="slide-right"
                                data-sal-delay="300"
                                data-sal-duration="1500"
